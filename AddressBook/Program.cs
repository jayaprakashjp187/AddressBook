                ...
                case 1:
                 ...
                 case 3:
                  ...
                  case 4:
                    ...
                    break; 
                  case 5:
                    List<Customer> i = new List<Customer>();
                    Customer t = new Customer { name = "jayaprakash", lastname = "Mudigonda", Address = "warangal", City = "hanamkonda", state = "Telangana", pin = 506342, num = 7337545935, Email = "jayaprakashjp187@gmail.com" };
                    Customer v = new Customer { name = "pallavi", lastname = "ediga", Address = "shivmogga", City = "bangalore", state = "karnataka", pin = 560001, num = 6361419518, Email = "pallavig1997@gmail.com" };

                    i.Add(t);
                    i.Add(v); 
                    Console.WriteLine("after deleting s variable");
                    foreach (Customer details in i)
                    {
                        Console.WriteLine("name=" + details.name);
